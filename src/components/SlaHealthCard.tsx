...
export default function SlaHealthCard() {
  return (
    <div className="bg-white dark:bg-[#091122] rounded-[2px] border border-slate-200/85 dark:border-[#162444] p-4 shadow-xs flex flex-col justify-between h-full">
      ...
      <div className="w-full h-2 rounded-full flex overflow-hidden mb-2 bg-slate-100 dark:bg-[#060b17]">
        {/* Green SLA Met Bar */}
      ...
      <div className="flex items-center justify-between text-[11px] text-slate-700 dark:text-slate-400">
        ...
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 rounded-[2px] bg-[#f59e0b]" />
          <span>Near: <strong className="font-semibold text-slate-900 dark:text-white">92</strong></span>
        </div>
        <div className="flex items-center gap-1.5">
          <div className="w-2 h-2 rounded-[2px] bg-[#ef4444]" />
