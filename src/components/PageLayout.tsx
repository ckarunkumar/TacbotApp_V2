...
export default function PageLayout({
  ...
  return (
    <div className="h-screen bg-[#F2F4F6] text-[#2C3746] font-sans antialiased flex flex-row w-full relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden transition-all duration-300 ease-[cubic-bezier(0.2,0,0,1)]">
        ...
        <main className={`flex-1 flex flex-col min-h-0 overflow-hidden ${contentClassName ? contentClassName : "pt-2 px-2 pb-2"}`}>
          {children}
        </main>
      </div>
