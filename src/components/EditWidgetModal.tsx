...
export default function EditWidgetModal() {
  ...
  const [rowSpan, setRowSpan] = useState<1 | 2 | 3 | 4>(1);
      ...
      <div className="p-4 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className="w-full text-xs text-slate-800 dark:text-slate-100 bg-white dark:bg-[#091122] border border-slate-200 dark:border-[#162444] rounded-[2px] px-3 py-2 focus:outline-none focus:border-[#0047ba] font-normal"
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="text-xs border border-slate-200 dark:border-[#162444] rounded-[2px] px-2 py-2 focus:outline-none focus:border-[#0047ba] bg-white dark:bg-[#091122] text-slate-800 dark:text-slate-100 font-normal"
            >
            ...
            <div className="grid grid-cols-4 gap-1">
              {([1, 2, 3, 4] as const).map((cols) => (
                <button
                  ...
                  className={`py-1.5 text-xs rounded-[2px] transition-all cursor-pointer ${
                    colSpan === cols
                      ? "bg-[#0047ba] text-white font-semibold shadow-xs"
                      : "bg-white dark:bg-[#091122] border border-slate-200 dark:border-[#162444] text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-[#0e1d38]"
                  }`}
                >
                  {cols}W
                </button>
