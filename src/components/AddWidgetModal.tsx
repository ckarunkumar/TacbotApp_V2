...
export default function AddWidgetModal() {
  ...
  const [selectedFilter, setSelectedFilter] = useState("My widgets");
                ...
                <div className="flex flex-col gap-2">
                  {userCustomWidgets.map((custom) => (
                    ...
                    >
                      ...
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-150 flex items-center gap-1.5 shrink-0">
                        <ShareWidgetButton
