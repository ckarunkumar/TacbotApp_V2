...
export default function Badge({
  ...
  const getVariantStyles = () => {
    switch (variant) {
      case "dimension":
      case "neutral":
        return "bg-[#F2F4F6] text-[#7790A9] border border-[#EAEEF3] text-[9px] font-medium px-1.5 py-0.5";
      case "success":
      ...
      case "info":
        return "bg-[#ECF3FF] text-[#002E5D] border border-[#D4E4FE] text-[10px] font-semibold px-2 py-0.5";
      case "purple":
