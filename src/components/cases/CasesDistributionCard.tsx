...
export interface CasesDistributionCardProps {
  ...
  onSelectVendorFilter?: (vendorName: string) => void;
}
...
export default function CasesDistributionCard({
  ...
  const handleVendorClick = (vendor: string) => {
    if (zoomedVendor === vendor) {
      setZoomedVendor(null);
      if (onSelectVendorFilter) {
        onSelectVendorFilter("All");
      }
    } else {
      setZoomedVendor(vendor);
      if (onSelectVendorFilter) {
        onSelectVendorFilter(vendor);
      }
    }
  };
  ...
  return (
    <div className="bg-white dark:bg-[#091122] rounded-[8px] border border-[#EAEEF3] dark:border-[#162444] p-4 shadow-xs flex flex-col justify-between h-full transition-all">
      ...
      <div className="flex items-center justify-between mb-2 select-none">
        ...
        {/* Right Breadcrumbs Filter + Info Icon + Minimize Toggle */}
          ...
          <Tooltip
            content={
              zoomedVendor
                ...
                : "Distribution and concentration of Connectivity cases by network vendor — click a block to drill into severity mix"
            }
            position="top"
          >
            <button
      ...
      {/* VIEW 1: Low Severity Categories Mosaic View */}
      {showLowCategories && (
        <div className="grid grid-cols-12 gap-2 flex-1 min-h-[170px] w-full select-none animate-in fade-in duration-150">
          <button
            type="button"
      ...
      {/* VIEW 2: Connectivity Vendor Mosaic View */}
      {showConnectivityVendors && (
        <div className="grid grid-cols-12 gap-2 flex-1 min-h-[170px] w-full select-none animate-in fade-in duration-150">
          <button
            ...
            title="Click to drill into Cisco severity breakdown"
          >
          ...
          <button
            ...
            title="Click to drill into Juniper severity breakdown"
          >
          ...
          <div className="col-span-4 flex flex-col gap-2 h-full">
            <div className="grid grid-cols-2 gap-2 flex-1">
              <button
                ...
                title="Click to drill into Arista severity breakdown"
              >
              ...
              <button
                ...
                title="Click to drill into Fortinet severity breakdown"
              >
            ...
            <div className="grid grid-cols-3 gap-2 flex-1">
              <button
                ...
                title="Click to drill into Palo Alto severity breakdown"
              >
              ...
              <button
                ...
                title="Click to drill into F5 severity breakdown"
              >
              ...
              <button
                type="button"
                onClick={() => handleVendorClick("Others")}
                ...
                title="Click to drill into Others severity breakdown"
              >
